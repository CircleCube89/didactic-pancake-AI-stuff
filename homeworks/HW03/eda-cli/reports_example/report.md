...
- Содержит столбцы с одинаковыми зачениями: **False**
- Идентификаторы не по порядку (не строка, иначе всегда False; возможен ложно положительны результат при наличии дубликатов): **False**
